...
import Tenzinn.UI.Pages.MenuUI;
...
public class MenuCommand extends AbstractPlayerCommand {
    ...
    public MenuCommand(String name, String description) { super(name, description); }
    ...
    protected void execute(@NonNullDecl CommandContext commandContext, @NonNullDecl Store<EntityStore> store, @NonNullDecl Ref<EntityStore> ref,
        ...
        player.getPageManager().openCustomPage(ref, store, new MenuUI(playerRef));
    }
}