...
import Tenzinn.UI.Pages.SkillUI;
...
public class SkillCommand extends AbstractPlayerCommand {
    ...
    public SkillCommand(String name, String description) { super(name, description); }
    ...
    protected void execute(@NonNullDecl CommandContext commandContext, @NonNullDecl Store<EntityStore> store, @NonNullDecl Ref<EntityStore> ref,
        ...
        player.getPageManager().openCustomPage(ref, store, new SkillUI(playerRef));
    }
}