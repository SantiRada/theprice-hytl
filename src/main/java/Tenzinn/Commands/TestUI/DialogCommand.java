...
import Tenzinn.UI.Pages.DialogUI;
...
public class DialogCommand extends AbstractPlayerCommand {
    ...
    public DialogCommand(String name, String description) { super(name, description); }
    ...
    protected void execute(@NonNullDecl CommandContext commandContext, @NonNullDecl Store<EntityStore> store, @NonNullDecl Ref<EntityStore> ref,
        ...
        player.getPageManager().openCustomPage(ref, store, new DialogUI(playerRef));
    }
}